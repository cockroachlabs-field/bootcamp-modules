...
import io.cockroachdb.bootcamp.common.annotation.Retryable;
...
public class TransactionRetryAspect {
    ...
    @Around(value = "io.cockroachdb.bootcamp.common.aspect.Pointcuts.anyRetryableOperation(retryable)",
