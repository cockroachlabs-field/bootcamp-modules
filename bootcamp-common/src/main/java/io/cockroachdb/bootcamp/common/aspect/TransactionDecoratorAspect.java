package io.cockroachdb.bootcamp.common.aspect;
...
import io.cockroachdb.bootcamp.common.annotation.TransactionPriority;
...
public class TransactionDecoratorAspect {
    ...
    @Around(value = "io.cockroachdb.bootcamp.common.aspect.Pointcuts.anyExplicitTransactionBoundary(transactionExplicit)",
