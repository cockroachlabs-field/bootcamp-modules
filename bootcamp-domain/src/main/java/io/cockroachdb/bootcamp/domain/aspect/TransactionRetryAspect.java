...
import io.cockroachdb.bootcamp.domain.annotation.Retryable;
...
public class TransactionRetryAspect {
    ...
    @Around(value = "io.cockroachdb.bootcamp.domain.aspect.Pointcuts.anyRetryableOperation(retryable)",
