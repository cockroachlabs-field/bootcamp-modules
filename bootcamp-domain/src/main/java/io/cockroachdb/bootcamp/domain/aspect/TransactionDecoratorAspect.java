package io.cockroachdb.bootcamp.domain.aspect;
...
import io.cockroachdb.bootcamp.domain.annotation.TransactionPriority;
...
public class TransactionDecoratorAspect {
    ...
    @Around(value = "io.cockroachdb.bootcamp.domain.aspect.Pointcuts.anyExplicitTransactionBoundary(transactionExplicit)",
